...
def pregunta_01():
    """
    En este laboratorio debe construir un modelo predictivo de clasificación
    para la identificación de hongos venenosos. La base de datos contiene 8124
    ...
    comestibilidad indeterminada. Por el tipo de problema en cuestión, los
    hongos de comestibilidad desconocida deben ser asignados a la clase de
    hongos venenosos, ya que no se puede correr el riesgo de dar un hongo
    potencialmente venenoso a una persona para su consumo.
    ...
    `data/test_dataset.csv`. El modelo obtenido debe ser salvado en el archivo
    `models/model.pkl`.
