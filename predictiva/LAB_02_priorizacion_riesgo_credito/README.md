...
`data/train_data.csv.zip` y `data/test_data.csv.zip` contienen registros reales anonimizados de tarjetas de crédito, con límite, historial de pagos, facturación, abonos y default observado.
