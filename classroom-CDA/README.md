# Laboratorios de programación -- Curso: Ciencia de los Datos Aplicada

Este repo contiene las tareas asignadas para el curso Ciencia de los Datos Aplicada, ofertado en la Facultad de Minas, Universidad Nacional de Colombia, Sede Medellín.
