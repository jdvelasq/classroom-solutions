...
Versionado de código, datos, modelos, configuraciones y prompts; registro de experimentos, artefactos, linaje y documentación. MLflow puede ser un ejemplo, no el objeto del curso.
...
Productos recibe una capacidad analítica ya definida y la convierte en una oferta utilizable, confiable y sostenible. No vuelve a enseñar EDA, modelado o optimización; trata prácticas de construcción solo cuando habilitan valor, calidad, seguridad u operación de la capacidad analítica.
