...
- Todo PRE nuevo incluye `HOW_TO_RUN_ME.txt` en su raíz. Debe dar comandos mínimos, ordenados y ejecutables desde la raíz del PRE para que un estudiante pueda ejecutar y verificar la actividad sin inferir pasos técnicos.
