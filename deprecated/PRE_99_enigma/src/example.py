...
from deprecated.PRE_99_enigma.src.enigma_machine import (
    apply_enigma_machine,
    initialize_enigma_machine,
    make_enigma_machine,
)
from deprecated.PRE_99_enigma.src.plugboard import make_plugboard
from deprecated.PRE_99_enigma.src.reflector import REFLECTOR_B
from deprecated.PRE_99_enigma.src.rotor import (
    ROTOR_1,
    ROTOR_3,
    ROTOR_5,
)
