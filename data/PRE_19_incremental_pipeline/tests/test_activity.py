...
def test_current_state_is_unique_and_contains_change_results():
    x=pd.read_csv(ROOT/"submission/customers_current.csv");assert x.customer_id.is_unique and x.customer_id.tolist()==["C1","C2","C3","C4"] and x.loc[x.customer_id=="C2","segment"].iloc[0]=="Corporate"
